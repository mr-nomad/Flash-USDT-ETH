An open-source Python/Tkinter app compile to .exe for educational stablecoin flash transactions on Ethereum. Connect via Infura, manage wallets, and send transactions with USDT, USDC, or DAI.
Key Features:
